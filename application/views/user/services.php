...
<head>
    ...
    <!-- Title  -->
    <title>M & S Land Consultancy | Services</title>
    ...
    <script src="https://use.fontawesome.com/6416f3e380.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="elements-title">
                        <h2>Our Professional Services Include</h2>
                    </div>
                </div>
                                ...
                                echo '<div class="col-12 col-md-6 col-lg-4">'.
                                        '<div class="single-service-area mb-100">'.
                                            '<div class="service-content">'.
                                                '<h5><i class="fa '.$services[$i]['icon'].' fa-2x"></i>&nbsp;&nbsp;&nbsp; '.$services[$i]['name'].'</h5>'.
                                                '<p>'.$services[$i]['des'].'</p>'.
                                            '</div>'.
                                        '</div>'.
                                     '</div>';
