...
<head>
    ...
    <!-- Title  -->
    <title>M & S Land Consultancy | About Us</title>
            ...
            <div class="row">
                <div class="col-12 col-lg-10">
                    <div class="section-heading text-left wow fadeInUp" data-wow-delay="250ms">
                        <h2>M & S Land Consultancy</h2>
                        <p>Years of experience at your service</p>
                    </div>
                    <div class="about-content">
                        <img class="wow fadeInUp" data-wow-delay="350ms" src="<?php echo base_url(); ?>vendor/img/bg-img/about.jpg" alt="">
                        ...
                        <?php                 
                            /*if(isset($popularListings)){
                                if(count($popularListings) > 0){
                                    echo '<div class="featured-properties-slides owl-carousel wow fadeInUp" data-wow-delay="350ms">';
                                    for($i = 0; $i < count($popularListings); $i++){

                                        echo  '<div class="single-featured-property">'.
                                                    '<div class="property-thumb">'.
                                                        '<img src="'.base_url().'vendor/img/bg-img/'.$popularListings[$i]['cover'].'" alt="">'.
                                                        '<div class="tag">'.
            ...
            <div class="row align-items-center h-100">
                <div class="col-12">
                    <div class="cta-content text-center">
                        <h2 class="wow fadeInUp" data-wow-delay="300ms">Make the most out of your investment</h2>
                        <h6 class="wow fadeInUp" data-wow-delay="400ms">Successful investing starts with courage</h6>
                        <a href="properties" class="btn south-btn mt-50 wow fadeInUp" data-wow-delay="500ms">Let's go</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-lg-6">
                    <div class="single-team-member mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="team-member-thumb">
                            <img src="<?php echo base_url(); ?>vendor/img/bg-img/team1.jpg" alt="">
                        </div>
                        <!-- Team Member Info -->
                        <div class="team-member-info">
                            <div class="section-heading">
                                <img src="<?php echo base_url(); ?>vendor/img/icons/prize.png" alt="">
                                <h2>John Doe</h2>
                                <p>Realtor</p>
                            </div>
                            <div class="address">
                                <h6><img src="<?php echo base_url(); ?>vendor/img/icons/phone-call.png" alt=""> +501 615-0085</h6>
                ...
                <div class="col-12 col-sm-6 col-lg-6">
                    <div class="single-team-member mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="<?php echo base_url(); ?>vendor/img/bg-img/team2.jpg" alt="">
                        </div>
                        <!-- Team Member Info -->
                        <div class="team-member-info">
                            <div class="section-heading">
