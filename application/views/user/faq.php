<?php 
    ...
    if($this->session->userdata('faqs')){    
        $faqs = $this->session->userdata('faqs');        
    } 
...
<head>
    ...
    <!-- Title  -->
    <title>M & S Land Consultancy | FAQs</title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">FAQs</h3>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                if(isset($faqs)){
                                    if(count($faqs)>0){
                                        for($i=0; $i<count($faqs); $i++){
                                            ...
                                            echo '<div class="panel single-accordion">'.
                                                    '<h6>'.
                                                        '<a role="button" aria-expanded="true" aria-controls="collapse-'.$faqs[$i]['id'].'" class="collapsed" data-parent="#accordion" data-toggle="collapse" href="#collapse-'.$faqs[$i]['id'].'">'.
                                                            $faqs[$i]['title'].
                                                            '<span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>'.
                                                            '<span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>'.
                                                        '</a>'.
                                                    '</h6>'.
                                                    '<div id="collapse-'.$faqs[$i]['id'].'" class="accordion-content collapse">'.
                                                        '<p>'.$faqs[$i]['ans'].'</p>'.
                                                    '</div>'.
                                                 '</div>';
